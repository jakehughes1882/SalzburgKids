(function () {
	...
	var div = d3.select("#container_player_xG_Diff_bar").append("div")
    .attr("class", "tooltipbar_player_xg")
    .style("opacity", 0);
	...
	d3.csv("https://raw.githubusercontent.com/jakehughes1882/data/master/UCL_2019_Player_Stats.csv", type, function(error, data) {	
		...
		// create svg
		var svg = d3.select("#container_player_xG_Diff_bar")
			.append("svg")
	...
	var bars = 	svg.selectAll(".bar")
			...
			bars.on("mouseover", function(d) {
				...
				div.transition()
				 .duration(200)
         .style("opacity", 1.0);
				div.html(d.Player + " scored " + d.Goals + " goals, but had an xG sum of " + d.xG + " leaving a difference of " + d.xGDiff)
